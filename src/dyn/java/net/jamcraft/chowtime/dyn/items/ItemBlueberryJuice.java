 ...
 */
public class ItemBlueberryJuice extends Item implements IDynItem
{

    public ItemBlueberryJuice()
    {
        super();
        setCreativeTab(ChowTime.creativeTab);
        setTextureName(ModConstants.MODID + ":blueberryJuice");
        setUnlocalizedName("blueberryJuice");
    }

    @Override public String getRegistrationName()
    {
        return "blueberryjuice";
    }
