 ...
 */
public class CropCranberry extends BlockCrops implements ICrop
{
    @SideOnly(Side.CLIENT)
    private IIcon[] icons;

    public CropCranberry()
    {
        super();
        float f = 0.5F;
    ...
    {
        return meta == 7 ? CTInits.Cranberry : CTInits.CranberrySeeds;
    }

    @Override
    protected Item func_149866_i()
    {
        return CTInits.CranberrySeeds;
    }
    ...
    public void registerBlockIcons(IIconRegister icon)
    {
        ...
        {
            this.icons[i] = icon.registerIcon(ModConstants.MODID + ":" + "cranberry_stage_" + i);
        }
    }
