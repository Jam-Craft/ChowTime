 ...
 */
public class CropGrape extends BlockCrops implements ICrop
{
    ...
    {
        return meta == 7 ? CTInits.Grape : CTInits.GrapeSeeds;
    }

    @Override
    protected Item func_149866_i()
    {
        return CTInits.GrapeSeeds;
    }
    ...
    public void registerBlockIcons(IIconRegister icon)
    {
        ...
        {
            this.icons[i] = icon.registerIcon(ModConstants.MODID + ":" + "grape_stage_" + i);
        }
    }
