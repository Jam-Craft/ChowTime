...
//        this.setBlockTextureName(ModConstants.MODID + ":barley");
    ...
    {
        return meta == 7 ? CTInits.Raspberry : CTInits.RaspberrySeeds;
    }

    @Override
    protected Item func_149866_i()
    {
        return CTInits.RaspberrySeeds;
    }
    ...
    public void registerBlockIcons(IIconRegister icon)
    {
        ...
        {
            this.icons[i] = icon.registerIcon(ModConstants.MODID + ":" + "raspberry_stage_" + i);
        }
    }
